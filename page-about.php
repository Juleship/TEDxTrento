	...
	<div class="col-sm-6 col-sm-offset-3">
		...
		<div class="tab-content">
		  <div class="tab-pane active" id="ted">
			...
			<p>
				Nella Conferenza annuale di TED i maggiori protagonisti del “pensare” e del “fare” sono invitati a condividere le loro idee in presentazioni di massimo 18 minuti. Le Conferenze di TED hanno visto in passato Roger Ebert, Sheryl Sandberg, Bill Gates, Elizabeth Gilbert, Benoit Mandelbrot, Philippe Starck, Ngozi Okonjo-Iweala, Brian Greene, Isabel Allende and l’ex primo ministro inglese Gordon Brown.
			</p>
			<p>
				Ci sono tre eventi TED ogni anno: la conferenza TED si tiene ogni primavera a Vancouver, Canada, in contemporanea a TEDActive, a Whistler, BC; TEDGlobal si tiene ogni estate a Edimburgo, Scozia.
			</p>
			<p>
				Su TED.com vengono archiviati e messi a disposizione giornalmente i TEDTalks. Attraverso l’Open Translation Project, i TEDTalks sono sottotitolati in più di 90 lingue grazie al lavoro di volontari da ogni parte del mondo. Tramite le nostre reti di distribuzione i TEDTalks sono condivisi in: TV, radio, Netflix e tanti siti.
			</p>
			<p>
		  ...
		  <div class="tab-pane" id="tedxtrento">
			  <p>
